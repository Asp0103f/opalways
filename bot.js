...
var bot_token = '5710017569:AAHcxxfjx2b1hNhWsWJzVUZKdz0SUtmYcxI'; //YOUR BOT TOKEN HERE

var bot_name = 'FimerCash'; // Bot Name
...
const admin_id = 1430529966;

const admin_id2 = 1218033255;
            ...
            if (flag == channel.length) {
                ...
                if (statdata.length == 0) {
                    ...
                    ctx.reply(
                        ...
                        '<b>📊 Bot Live Stats 📊\n\n📤 Total Payouts : 0 ' + currency + '\n\n💡 Total Users: ' + members.length + ' Users\n\n✅ Created By : <a href="tg://user?id=1430529966">DAD</a></b>' , { parse_mode: 'html', reply_markup: { keyboard: [['💰 Balance'], ['👫 Invite', '🎁 Bonus', '🗂 Wallet'], ['💵 Withdraw', '📊 Statistics']], resize_keyboard: true } }
